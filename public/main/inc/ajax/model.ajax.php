                ...
                if ($obj->usergroup_was_added_in_course(
                    ...
                    $actions = [
                        [
                            ...
                            'confirm' => get_lang('Are you sure to remove the class without removing students')
                        ],
                        [
                            ...
                            'confirm' => get_lang('Are you sure to remove the class')
                        ],
                    ];
                } else {
                    $actions = [
                ...
                if ($isAllow) {
                    ...
                    for ($i = 0; $i < count($actions); $i++) {
                        $group['actions'] .= Display::url(
                            $actions[$i]['icon'],
                            $actions[$i]['url'],
                            ['onclick' => isset($actions[$i]['confirm']) ? "if (!confirm('". $actions[$i]['confirm']. "')) return false;" : '']
                        );
                    }
                }
                $new_result[] = $group;
